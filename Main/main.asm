...
.sdsctag 1.0, "Country Roads", "A PSG Experiment","SteelFinger Studios"
;Programmed by Bofner
...
.enum $c000 export
    ...
    scrollX2Frac    dw          ;Fractional position $WHOLELO, FRAC $UNUSED, WHOLEHI
    scrollX3Frac    dw          ;Fractional position $WHOLELO, FRAC $UNUSED, WHOLEHI
    scrollX4Frac    dw          ;Fractional position $WHOLELO, FRAC $UNUSED, WHOLEHI

    scrollY         db          ;Generic, no parallax scrollY

    randSeed        db          ;random number seed
...
.include "..\\Object_Files\\plants.asm"
.include "..\\Object_Files\\stationWagon.asm"
